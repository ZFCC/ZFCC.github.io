...
+ 感谢[Solar](https://github.com/mattvh/solar-theme-jekyll)的原作者[Matt Harzewski](http://www.webmaster-source.com/)，在`2018.12`我打算建立自己的的博客，并选用了此样式模版，再次感谢样板的提供者。
...
热爱开源，热爱折腾的Java程序猿。更多个人信息和联系方式可以参照[我的简介](https://zfclwj.xyz/about/)。
